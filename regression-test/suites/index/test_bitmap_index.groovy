...
suite("test_bitmap_index", "index") {
    ...
    test{
        ...
        exception "errCode = 2, detailMessage = BITMAP or INVERTED index only used in columns of DUP_KEYS/UNIQUE_KEYS table or key columns of AGG_KEYS table. invalid column: v1"
    }
